package com.example.sprint_7.order;
...
public class CreateOrderTest {
    ...
    private int track;
    private String firstName = "Vedro";
    private String lastName = "Sosna";
    private String address = "Saint P";
    private String metroStation = "69";
    private String phone = "88005553535";
    private int rentTime = 4;
    private String deliveryDate = "2023.06.29";
